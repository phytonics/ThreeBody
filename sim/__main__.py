...
def getSoln(n: int = 1) -> Tuple[np.ndarray, int]:
    ...
    if n == 1:  # Triple Rings Lined Up
        ...
        return (
            np.m[-0.602885898116520, 1.059162128863347-1::0.252709795391000, 1.058254872224370-1::-0.355389016941814, 1.038323764315145 -
                 1::0.122913546623784, 0.747443868604908::-0.019325586404545, 1.369241993562101::-0.103587960218793, -2.116685862168820],
            284
        )
